...
### 💽 ORMs and Databases:
![ORMs and Databases](https://skillicons.dev/icons?i=postgres,sqlite,mongodb,mysql,sequelize,prisma,typeorm) ![TypeOrm](https://simpleskill.icons.workers.dev/svg?i=typeorm)
